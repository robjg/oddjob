...
public class OddballsDescriptorFactoryTest extends OjTestCase {
    ...
    @Test
    public void testOddballsExample() {
    ...
    @Test
    public void testOddballsExampleFiles() {
        ...
        Oddjob oddjob = new Oddjob();
        oddjob.setConfiguration(
                new XMLConfiguration("org/oddjob/oddballs/OddballsFilesExample.xml",
                        getClass().getClassLoader()));
    ...
    public void testClassResolverClassLoaders() {
        ...
        logger.info("ClassLoader 0: {}", classLoaders[1].toString());
        logger.info("ClassLoader 1: {}", classLoaders[1].toString());
        logger.info("ClassLoader 2: {}", classLoaders[2].toString());

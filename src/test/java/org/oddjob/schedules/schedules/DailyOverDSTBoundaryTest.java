...
public class DailyOverDSTBoundaryTest extends OjTestCase {

    private static final Logger logger = LoggerFactory.getLogger(DailyOverDSTBoundaryTest.class);
     ...
     */
    @Test
    public void testCalendarAssuptionsAutumn() {
        ...
        assertEquals(60 * 60 * 1000L, cal1.get(Calendar.DST_OFFSET));
        ...
        Date sunday1AM_GMT = DateHelper.parseDateTime("2005-10-30T01:00:00Z");
	 ...
	 */
    @Test
    public void testCalendarAssuptionsSpring() {
        TimeZone.setDefault(TimeZone.getTimeZone("Europe/London"));
    ...
    public void testDateParsing() {
        ...
        assertEquals(60 * 60 * 1000L, cal.get(Calendar.DST_OFFSET));
    ...
    @Test
    public void testDayLightSavingInAutumnWithAtBoundry() {
        TimeZone.setDefault(TimeZone.getTimeZone("Europe/London"));
    ...
    @Test
    public void testDayLightSavingInAutumnWithAtBoundry2() {
        TimeZone.setDefault(TimeZone.getTimeZone("Europe/London"));
    ...
    @Test
    public void testDayLightSavingInAutumnWithFromToOnBoundry() {
        TimeZone.setDefault(TimeZone.getTimeZone("Europe/London"));
    ...
    @Test
    public void testDayLightSavingInAutumnWithFromToSpanningBoundry() {
        TimeZone.setDefault(TimeZone.getTimeZone("Europe/London"));

...
public class OddjobNestedTest extends OjTestCase {
     ...
     */
    @Test
    public void testNestedOddjob() throws URISyntaxException {
    ...
    public void testExportBean() throws ArooaPropertyException, ArooaConversionException {
        ...
        assertEquals("java.lang.Object", text1);

        String text2 = lookup.lookup("inner/echo2.text",
                String.class);

        assertEquals("java.lang.String", text2);

        String text3 = lookup.lookup("inner/echo3.text",
                String.class);

        assertEquals("org.oddjob.io.FileType", text3);

...
public class TimerRetryCombinationTest extends OjTestCase {
    ...
    @Test
    public void testContextReset() throws ArooaConversionException, InterruptedException {
...
//		explorer.run();
    ...
    private static class OurClock implements Clock {
     ...
     */
    @Test
    public void testRetriesWithCatchup() throws ArooaConversionException, InterruptedException {
...
//		explorer.run();
        ...
        logger.info("** Destroying Oddjob2. **");
    ...
    @Test
    public void testSimpleTimerRetryExample() throws ArooaPropertyException, ArooaConversionException, InterruptedException, FailedToStopException {

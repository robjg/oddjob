...
public class ChildHelperTest extends OjTestCase {
    ...
    public void testReplaceChild() {
        ...
        ChildHelper<Object> test = new ChildHelper<>(
                new MockStructural());
    ...
    public void testDeadlockOnNotify() throws InterruptedException {
        ...
        final ChildHelper<Object> test = new ChildHelper<>(new MockStructural());
    ...
    private static class StructureAlteringListener implements StructuralListener {
    ...
    public void testNoMissedEvent() {
        ...
        ChildHelper<String> test = new ChildHelper<>(new MockStructural());
    ...
    public void testAddAndRemove() {
        ...
        ChildHelper<Object> test = new ChildHelper<>(new MockStructural());

...
public class LogArchiverHelperTest extends OjTestCase {
    ...
    public void testRetrieveLogEvents() {
        ...
        LogEvent[] events = LogArchiverHelper.retrieveLogEvents(bean, archiver, 0L, 10);

        assertEquals("component", bean, archiver.component);
        assertEquals("log level", LogLevel.DEBUG, archiver.level);
        assertEquals("from", 0L, archiver.last);

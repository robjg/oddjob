...
public class JMXClientJobTest extends OjTestCase {
     ...
     * Fixture
     */
    public static class ServerChild implements Structural {
        ChildHelper<Object> childHelper = new ChildHelper<>(this);
        String name;
...
//		System.setProperty("mx4j.log.priority", "trace");
    ...
    public void testRun() throws Exception {
        ...
        try (OddjobConsole.Close ignored = OddjobConsole.initialise()) {
            ...
            Object[] children2 = OddjobTestHelper.getChildren(children[0]);
    ...
    public static class Echo {
        ...
        public Object getEchoWrapped() {
            ...
            return new ComponentTransportable(1L);
        }
    ...
    static class Owner extends MockBeanDirectoryOwner implements Structural {
    ...
    private static class JobCounter implements StructuralListener {
        ...
        private final Set<Object> jobs = new HashSet<>();
    ...
    public void testDestroyWithComplicatedStructure() throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> logger.info("Tree built and event queue should be clear."));
        ...
        SwingUtilities.invokeAndWait(() -> logger.info("Tree destroyed and event queue should be clear."));

...
public class BufferTypeTest extends OjTestCase {
    ...
    @Test
    public void testFileWritingAndCaptureExamples() throws IOException {

        Path workDir = OurDirs.workPathDir(getClass().getSimpleName(), true);

        Oddjob oddjob1 = new Oddjob();
        oddjob1.setArgs(new String[]{workDir.toString()});
        ...
        oddjob2.setArgs(new String[]{workDir.toString()});

 ...
 * @author Rob Gordon
 */
public class ParameterisedExecutionService extends SimpleService
implements ParameterisedExecution, Structural {
			...
			((Stateful) job).addStateListener(new StateListener() {
				...
				public void jobStateChange(StateEvent event) {
					if (!event.getState().isStoppable()) {
						ParameterisedExecutionService.this.properties = null;

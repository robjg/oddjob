 ...
 * @author Rob Gordon 
 */
public class ParameterisedAction extends JobAction 
implements StateListener {
	...
	protected void doPrepare(ExplorerContext explorerContext) {
		...
		if (component instanceof ParameterisedExecution) {
	...
	protected void doAction() throws Exception {
		final ParameterisedExecution execution = (ParameterisedExecution) job;

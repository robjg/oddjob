 ...
 *
 */
public class DayOfYearScheduleDE implements DesignFactory {
	
	public DesignInstance createDesign(ArooaElement element,
			ArooaContext parentContext) {

		return new DayOfYearScheduleDesign(element, parentContext);
	}
}

class DayOfYearScheduleDesign extends ParentSchedule {
	
	private final SimpleTextAttribute on; 
	private final SimpleTextAttribute from;
	private final SimpleTextAttribute to;
			
	public DayOfYearScheduleDesign(ArooaElement element, ArooaContext parentContext) {

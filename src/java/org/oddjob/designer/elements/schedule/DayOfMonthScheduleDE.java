 ...
 *
 */
public class DayOfMonthScheduleDE implements DesignFactory {
	
	public DesignInstance createDesign(ArooaElement element,
			ArooaContext parentContext) {

		return new DayOfMonthScheduleDesign(element, parentContext);
	}
}

class DayOfMonthScheduleDesign extends ParentSchedule {
	
	private final SimpleTextAttribute on;
	private final SimpleTextAttribute from;
	private final SimpleTextAttribute to;
				
	public DayOfMonthScheduleDesign(ArooaElement element, ArooaContext parentContext) {

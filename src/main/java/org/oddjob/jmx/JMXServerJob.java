 ...
 * <p>
 * @oddjob.example Creating a server using the platform MBean Server.
 * <p>
 ...
 * @oddjob.example Creating a server using an RMI registry.
 * <p>
 ...
 * @oddjob.example Creating a secure server.
 * <p>
...
public class JMXServerJob implements ArooaSessionAware, JmxServer {
    ...
    public void start()
        ...
        this.factory = ServerSideBuilder.withSession(session)
                .andEnvironment(environment)
                .andHandlerFactories(this.handlerFactories)
                .andLogFormat(this.logFormat)
                .buildWith(server,

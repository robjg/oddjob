 ...
 * <p>
 * @oddjob.example Connect to a remote server that is using the Platform MBean Server. This
 ...
 * {@link JMXServerJob}.
 * @oddjob.example To create a connection to a remote server that is using an RMI registry
 * using the full form of the JMX URL.
 * <p>
 * {@oddjob.xml.resource org/oddjob/jmx/ClientExample.xml}
 * @oddjob.example Connect, run a remote job, and disconnect.
 * <p>
 ...
 * @oddjob.example Connect using a username and password to a secure server.
 * <p>
 * {@oddjob.xml.resource org/oddjob/jmx/SecureClientExample.xml}
 * @oddjob.example A local job triggers when a server job runs.
 * <p>

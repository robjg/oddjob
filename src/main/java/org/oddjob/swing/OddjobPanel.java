    ...
    protected void onStart() throws Throwable {
        ...
        frame.addComponentListener(new ComponentAdapter() {
            ...
            public void componentMoved(ComponentEvent e) {
                screen = ScreenPresence.of(e.getComponent());
            }
    ...
    class JobButtonAction extends AbstractAction {
        ...
        JobButtonAction(Runnable job) {
            ...
            if (job instanceof Iconic) {
                ...
                ((Iconic) job).addIconListener(e -> {
                    ImageData iconData = ((Iconic) job).iconForId(e.getIconId());
                    if (iconData == null) {
                        throw new NullPointerException("No icon for " + e.getIconId());
                    }
                    ImageIcon imageIcon = IconHelper.imageIconFrom(iconData);

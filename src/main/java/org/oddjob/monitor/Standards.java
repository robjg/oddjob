...
public class Standards extends org.oddjob.arooa.design.view.Standards {
	...
	public static final Integer START_MNEMONIC_KEY = new Integer(KeyEvent.VK_R);
	public static final KeyStroke START_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);
	
	public static final Integer SOFT_RESET_MNEMONIC_KEY = new Integer(KeyEvent.VK_S);
	public static final KeyStroke SOFT_RESET_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_J, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);
	
	public static final Integer HARD_RESET_MNEMONIC_KEY = new Integer(KeyEvent.VK_H);  
	public static final KeyStroke HARD_RESET_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_H, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);
	
	public static final Integer STOP_MNEMONIC_KEY = new Integer(KeyEvent.VK_T);  
	public static final KeyStroke STOP_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);

	public static final Integer FORCE_MNEMONIC_KEY = new Integer(KeyEvent.VK_F);  
	public static final KeyStroke FORCE_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);
	
	public static final Integer EXECUTE_MNEMONIC_KEY = new Integer(KeyEvent.VK_E);  
	public static final KeyStroke EXECUTE_ACCELERATOR_KEY = KeyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK + ActionEvent.ALT_MASK);
